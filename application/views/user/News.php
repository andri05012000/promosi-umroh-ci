  ...
  <!-- 
	...
	<body>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover text-center" data-stellar-background-ratio="0.5" style="background-image: url(<?php echo base_url(); ?>/template/listing/images/news.jpg);">
		...
		<div class="fh5co-section">
			<div class="container">
					<h1><?=$row->judul?>
					<p style="line-height: 1"> <?=$row->penulis?> - <?=$row->tanggal?></p></h1>
