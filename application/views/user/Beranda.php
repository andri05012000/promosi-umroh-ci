  ...
  <!-- 
	...
	<body>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover text-center" data-stellar-background-ratio="0.5" style="background-image: url(template/listing/images/1.jpg)">
				<div class="desc animate-box">
					<h2>FTI - Travel Umroh dan Haji Plus</h2>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 col-sm-4 fh5co-item-wrap" >
						<a class="fh5co-listing-item" target="_blank" href="<?php echo base_url('assets/upload/images/' . $row->image) ?>">
			...
			<div class="container">
				<div class="row" >
					...
					<div class="col-md-6 fh5co-news" >
						<h3 style="color: #000000">News</h3>
						<ul>
							<?php foreach ($berita as $row) : ?>
							<li>
								<a href="<?php echo base_url().'News/lengkap/'.$row->idberita; ?>">
									<span class="fh5co-date" style="color: #000000"><?php echo $row->tanggal;?></span>
									<h3 style="color: #000000"><?php echo $row->judul;?></h3>
									<p style="color: #000000">by <?php echo $row->penulis;?></p>
								</a>
							</li>
					<?php endforeach;?>
						</ul>
					...
					<div class="col-md-6 fh5co-testimonial">
						<img src="template/listing/images/bgsp1.jpeg" alt="Free HTML5 Bootstrap Template by FreeHTML5.co" class="img-responsive mb20">
						<img src="template/listing/images/bgsp2.jpeg" alt="Free HTML5 Bootstrap Template by FreeHTML5.co" class="img-responsive mb20">
						<img src="template/listing/images/bgsp3.jpeg" alt="Free HTML5 Bootstrap Template by FreeHTML5.co" class="img-responsive">
					</div>
				</div>
			</div>
		</div>
