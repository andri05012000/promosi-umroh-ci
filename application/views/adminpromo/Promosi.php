      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <a href="<?php echo base_url('Promosi'); ?>"  class="nav-link  active">
          ...
          <div class="col-12">
             <div class="card">
              <div class="card-header">
                <h3 class="card-title">Daftar Data Promosi</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                    ...
                    <?php
                      ...
                      <tr>
                        ...
                        <td style="text-align: center; vertical-align: middle;">
                          <img src="<?=base_url()?>assets/upload/images/<?=$upload->image?>" width="250px" alt="<?=$upload->image?>">
                        </td>
                        <td>
                          <a href ="<?php echo base_url('Promosi/edit/'.$upload->idpromosi); ?>" class="on-default edit-row btn btn-primary" class="col-sm-6 col-md-4 col-lg-3">
