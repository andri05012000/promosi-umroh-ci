      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Update Data Paket</h3>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="namapaket" value="<?=$upload->namapaket?>" required>
                </div>
              </div>
              <div class="col-md-12">
         ...
         <div class="card-footer">
                <input type="hidden" name="id" value="<?=$upload->idpaket?>">
                <td></td>
