          ...
          <div class="col-12">
             <div class="card">
              <div class="card-header">
                <h3 class="card-title">Daftar Data Tentang Kami</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                    <?php
                      ...
                      <tr>
                        ...
                        <td><?=$upload->isi?></td>
                        <td>
                          <a href ="<?php echo base_url('Tentang/edit/'.$upload->idtentangkami); ?>" class="on-default edit-row btn btn-primary" class="col-sm-6 col-md-4 col-lg-3">
